...
public class MathClient {
    public static void main(String[] args) throws Exception {
        String name = "Sameeraa_Client"; // Example name
        ...
        // 1. Initial Attachment with Name [cite: 17]
        ...
        if (MathProtocol.ACK.equals(response)) {
            ...
            // 2. Send 3 math requests at random times [cite: 18]
            Random rand = new Random();
            String[] ops = {"ADD", "SUB", "MUL"};
            
            for (int i = 0; i < 3; i++) {
                Thread.sleep(rand.nextInt(3000)); // Random delay
